  ...
  return (
    ...
    >
      <img
        ...
        className="size-20 tablet:size-24 laptop:size-36 object-contain mb-2"
      />
      <div className="flex flex-col gap-1">
        <h1 className="font-bold text-sm laptop:text-xl">
          {userName ? userName.toUpperCase() : "SPPKu"}
        </h1>
        <p className="phone:text-xs text-xl">
          {userAddress
            ? capitalizeEachWord(userAddress)
            : "Jl.Raya Telukjambe, Depan Perum Permata Hijau, Sukagalih, Telukjambe Timur, Karawang"}
        </p>
        <p className="phone:text-[0.55rem] phone:leading-tight text-xl">
          Telepon: {userPhoneNumber ? userPhoneNumber : "0856 9298 7957"}
        </p>
        <p className="phone:text-[0.55rem] phone:leading-tight text-xl">
          Laman: {frontendUrl}
        </p>
