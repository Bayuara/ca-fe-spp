  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day_selected:
          "bg-slate-900 text-white-300 hover:bg-slate-900 hover:text-slate-50 focus:bg-slate-900 focus:text-slate-50 dark:bg-hijauNormal dark:text-slate-100 dark:hover:bg-slate-50 dark:hover:text-slate-900 dark:focus:bg-slate-50 dark:focus:text-slate-900",
        day_today:
          "bg-slate-100 text-slate-900 dark:bg-slate-100 dark:text-slate-350",
        day_outside:
